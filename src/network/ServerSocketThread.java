...
public class ServerSocketThread extends Thread {
    ...
    HW4.network.ServerSocketThreadListener listener;

    public ServerSocketThread(HW4.network.ServerSocketThreadListener listener, String name, int port, int timeout) {
        super(name);
        this.port = port;
